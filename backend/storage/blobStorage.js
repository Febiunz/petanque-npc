...
/**
 * Azure Blob Storage helper for schedule.json
 * Both the backend and Azure Function use this to access the same schedule data
 */
...
export async function readScheduleFromBlob() {
  ...
  try {
    ...
    if (err.statusCode === 404) {
      throw new Error('schedule.json not found in Azure Blob Storage');
    }
    throw err;
  }
}
